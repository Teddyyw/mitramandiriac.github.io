...
<body class="sb-nav-fixed">
                                ...
                                <table class="table" id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <input type="hidden" name="idjenislayanandihapus" value="<?= $idpr; ?>">
                                            <a href="data_layananhapus.php?id=<?= $data["jenis_layanan"] ?>" class="btn btn-danger btn-sm m-1" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ?')">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>
                                                    ...
                                                    <form method="post">
                                                        <div class="form-group">
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <label for="jenis_layanan">Masukan Jenis Layanan</label>
                                                                    <input type="hidden" name="id" value="<?= $data['id'] ?>">
                                                                    <input type="text" name="jenis_layanan" value="<?= $jenis; ?>" class="form-control" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="harga">Input Harga</label>
                                                                    <input type="text" name="harga" value="<?= $harga; ?>" class="form-control" required>
                                                                </div>
                                                                <button type="submit" class="btn btn-primary" name="editlayanan" value="editlayanan">Submit</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <div class="modal" id="myModal">
        <div class="modal-dialog">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Tambah Data Jenis Layanan</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            ...
            <div class="modal-body">
            <label for="jenis_layanan">Masukan Jenis Layanan</label>
            <input type="text" name="jenis_layanan" placeholder="Jenis Layanan" class="form-control" required>
            <br>
            <label for="harga">Input Harga</label>
            <input type="text" name="harga" placeholder="Harga" class="form-control" required>
            <br>
            <button type="submit" class="btn btn-primary" name="addnewlayanan">Submit</button>
            </div>
            </form> 
            </div>
            </div>
