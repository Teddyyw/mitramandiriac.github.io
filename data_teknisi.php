                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <a href="data_teknisihapus.php?id=<?= $data["nama"] ?>" class="btn btn-danger btn-sm m-1" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ?')">
                                                                                    Delete
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                                                        <div class="modal" id="edit<?= $idt ?>">
                                                                                    ...
                                                                                    <form method="post">
                                                                                        <div class="form-group">
                                                                                            <div class="modal-body">
                                                                                                <div class="form-group">
                                                                                                    <label for="nama">Masukan Nama Teknisi</label>
                                                                                                ...
                                                                                                <button type="submit" class="btn btn-primary" name="editteknisi" value="editteknisi">Submit</button>
                                                                                            </div>
                                                                                    </div>
                                                                            </div>
                                                                        </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="post">
                                            <div class="modal-body">
                                                ...
                                                <br>
                                                <button type="submit" class="btn btn-primary" name="addnewteknisi">Submit</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
