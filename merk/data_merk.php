                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="sidebar-heading">
                            ...
                            <div class="sidebar-heading">
                                Data Perusahaan
                                <a class="nav-link" href="data_merk.php">
                                    <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                    Data Merk AC
                                </a>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table" id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                            $ambilsemuadatanya = mysqli_query($conn,"select * from tbl_merk");
                                            $i = 1;
                                            ...
                                            <tr>
                                                ...
                                                <a href="data_merkhapus.php?id=<?= $data["merk"] ?>" class="btn btn-danger btn-sm m-1" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ?')">
                                                    Delete
                                                </a>
                                            </td>
                                                        ...
                                                        <form method="post">
                                                            <div class="form-group">
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label for="merk">Masukan Nama Merk AC</label>
                                                                        <input type="hidden" name="id" value="<?= $data['id'] ?>">
                                                                        <input type="text" name="merk" value="<?= $merk; ?>" class="form-control" required>
                                                                    </div>
                                                                    <button type="submit" class="btn btn-primary" name="editmerk" value="editmerk">Submit</button>
                                                                    </div>
                                                            </div>
                                                        </div>
                                                        </div>
